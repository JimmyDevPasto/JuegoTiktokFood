...
import { FRIESMAN_COLUMNS, FRIESMAN_SPACE_COLUMNS, FRIESMAN_SPACE_ROW, GAMEBOARD_LENGTH, GAMEBOARD_LENGTH_HOT } from "../App";
import { HOTDOGMAN_COLUMNS,HOTDOGMAN_SPACE_COLUMNS,HOTDOGMAN_SPACE_ROW } from "../App";
    ...
    <>
      ...
      <group visible={status === "playing"}>
        ...
        {friesman.map((friesman, index) => {
          ...
          const xPos = column * FRIESMAN_SPACE_COLUMNS - (FRIESMAN_COLUMNS - 1) * FRIESMAN_SPACE_COLUMNS / 2;
          return (
            <group key={index} position-z={-1 - row * FRIESMAN_SPACE_ROW} position-x={xPos}>
        ...
        {hotdogman.map((hotdogman, index) => {
          ...
          const xPos = column * HOTDOGMAN_SPACE_COLUMNS - (HOTDOGMAN_COLUMNS - 1) * HOTDOGMAN_SPACE_COLUMNS / 2;
